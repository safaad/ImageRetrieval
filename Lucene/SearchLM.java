...
public class SearchLM {
	...
	IndexSearcher searcher;
	 Analyzer analyzer;
	public SearchLM() {
		index = "C:\\Users\\Safaa\\Desktop\\ProjectIR\\LuceneIndexLM";
		field = "contents";
		try {
	...
	public List< String> doPagingSearch( IndexSearcher searcher, Query query,
		...
		int end = Math.min(numTotalHits, hitsPerPage);
			...
			for (int i = start; i < end; i++) {
	            ...
	            TO = Paths.get("C:\\Users\\Safaa\\Desktop\\ProjectIR\\static\\img\\resultsLM"+imagepath+".jpg");
